...
//																						//
// Purpose: Manages all the textures loaded in the game			 						//
//																						//
//////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////
//	Function:	"CTextureManager(Destructor)"
///////////////////////////////////////////////////////////////////
CTextureManager::~CTextureManager(void)
{
}
...
///////////////////////////////////////////////////////////////////
bool CTextureManager::InitTextureManager(LPDIRECT3DDEVICE9 lpDevice, LPD3DXSPRITE lpSprite)
{
	m_lpDevice = lpDevice;
	m_lpDevice->AddRef();
...
//				.ppm, and .tga files.
///////////////////////////////////////////////////////////////////
int CTextureManager::LoadTexture(const char* szFilename, DWORD dwColorkey)
{
...
///////////////////////////////////////////////////////////////////
void CTextureManager::UnloadTexture(int nID)
{
...
///////////////////////////////////////////////////////////////////
int CTextureManager::GetTextureWidth(int nID)
{
	// Make sure the nID is in range.
	assert(nID > -1 && nID < (int)m_Textures.size() && "nID is out of range");
...
///////////////////////////////////////////////////////////////////
int CTextureManager::GetTextureHeight(int nID)
{
	// Make sure the nID is in range.
	assert(nID > -1 && nID < (int)m_Textures.size() && "nID is out of range");
...
///////////////////////////////////////////////////////////////////
bool CTextureManager::Draw(int nID, int nX, int nY, float fScaleX, float fScaleY,
...
void CTextureManager::OnResetDevice()
{
	for (unsigned int i = 0; i < m_Textures.size(); i++)
	{
		...
		HRESULT hr = 0;
		if (FAILED(hr = D3DXCreateTextureFromFileEx(m_lpDevice, m_Textures[i].filename, 0, 0, D3DX_DEFAULT, 0,
			D3DFMT_UNKNOWN, D3DPOOL_DEFAULT, D3DX_DEFAULT,
			D3DX_DEFAULT, 0, 0, 0, &m_Textures[i].texture)))
		{
			// Failed.
			char szBuffer[256] = {0};
			sprintf(szBuffer, "Failed to Create Texture - %s", m_Textures[i].filename);
			MessageBox(0, szBuffer, "TextureManager Error", MB_OK);
		}
	}
}
