...
namespace AK
{
	...
	namespace Wwise
	{
		...
		public:	
			...
			/// The result returned by DoOperation for a Rename operation
			/// A instance of this class is allocated by the plugin and freed by Wwise
			/// The Rename operation ID must be identified by PluginInfo::m_dwRenameCommandID
			class IRenameOperationResult : public IOperationResult
			{
			public:
			...
			/// The result returned by DoOperation for a Move operation
			/// A instance of this class is allocated by the plugin and freed by Wwise
			/// The Move operation ID must be identified by PluginInfo::m_dwMoveCommandID
			class IMoveOperationResult : public IOperationResult
			{
			public:
				...
				virtual unsigned int GetMovedFilesCount() = 0;
			};
